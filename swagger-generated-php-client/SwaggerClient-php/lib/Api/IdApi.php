...
class IdApi
{
     ...
     *
     * @param \Swagger\Client\Model\Protocolin $body Document Metadata (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\ProtocolNumber
     */
    public function postProtocol($body)
    {
        list($response) = $this->postProtocolWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation postProtocolWithHttpInfo
     *
     * Στο συγκεκριμένο URI μπορεί να πραγματοποιηθεί κλήση με μοναδικό αντκείμενο όπως περιγράφεται από το μοντέλο. Γνα να δεχτεί ο Server και να καταλάβει το έγγραφο (\"document\": \"string\") πρέπει αυτό να βρίσκεται σε Base64 μορφή
     *
     * @param \Swagger\Client\Model\Protocolin $body Document Metadata (required)
     ...
     */
    public function postProtocolWithHttpInfo($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling postProtocol');
        }
        // parse inputs
        $resourcePath = "/protocol/submit";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
